  ...
  return (
    <article>
      ...
      : <div className="cartProductsContainer">
          ...
          : 
          orderId ? <OrderConfirm orderId={orderId} products={orderConfirmed.products} totalPrice={orderConfirmed.totalPrice} /> 
            : 
            "Tu carrito se encuentra vacío"}
        {cartProducts.length ? <div className="cartProductsResume">
